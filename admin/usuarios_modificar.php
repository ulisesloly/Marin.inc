...
<?php
	if($_POST[enviar] == "Modificar"){
		$q="UPDATE `clientes` SET `nombre` = '$_POST[nombre]', `email` = '$_POST[email]', `telefono` = '$_POST[telefono]', `nacionalidad` = '$_POST[nacionalidad]', `direccion` = '$_POST[direccion]', `numero` = '$_POST[numero]', `municipio` = '$_POST[comuna]', `usuario` = '$_POST[usuario]', `contrasena` = '$_POST[contrasena]' WHERE `clientes`.`id` = $_POST[id];";
			    ...
			    <form class="well form-horizontal" method="post"  id="Modificar" name="Modificar"> 
							...
							<div class="col-md-4 selectContainer">
								<div class="input-group">
									...
									<select name="nacionalidad" id="nacionalidad" class="form-control selectpicker">
									  ...
									  <option value="Mexicona" <?php if($row[nacionalidad]=="Mexicona") echo selected ?>>Mexicona</option>
									</select>
							  </div>
							</div>
					</div>
					...
					<div class="form-group">
					  <label class="col-md-4 control-label">Número</label>  
					    ...
					    <div class="input-group">
					        <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
					  <input name="numero" id="numero" min=0 placeholder="N°" class="form-control" type="text" value="<?php echo $row[numero]?>">
					    </div>
					  </div>
					</div>
					...
					<div class="form-group">
					  <label class="col-md-4 control-label">Municipio</label>  
					    ...
					    <div class="input-group">
					        <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
					  <input name="comuna" id="comuna" placeholder="Municipio" class="form-control" type="text" value="<?php echo $row[comuna]?>">
					    </div>
					  </div>
					</div>
