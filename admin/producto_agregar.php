...
<?php
	if($_POST[agregarProducto] == "agregarProducto"){
		...
		$q="INSERT INTO `productos`(`id`, `nombre`, `codigo`, `categoria`, `frase_promocional`, `unidad`, `precio`, `disponibilidad`, `descripcion`, `promocion`, `image`) VALUES (NULL,'$_POST[nombre]','$_POST[codigo]','$categoria','$_POST[frase_promocional]','$unidad','$_POST[precio]',$_POST[disponibilidad],'$_POST[descripcion]', '$_POST[promocion]', '$userpic')";
        ...
        fields: {
            ...
            precio: {
                validators: {
                    ...
                    notEmpty: {
                        message: 'Ingrese precio del producto con numeros'
                    }
                }
            },
           }
        ...
        ?>
		    <div class="container">
			    <form class="well form-horizontal" method="post"  id="agregarProducto" name="registro" enctype="multipart/form-data">
					...
					<legend><center><h2><b>Agregar Productos</b></h2></center></legend><br>
					...
					<div class="form-group">
					  <label class="col-md-4 control-label">Precio</label>
					    ...
					    <div class="input-group">
					  	...
					  	<input name="precio" id="precio" placeholder="Ingrese Precio $" class="form-control" type="number">
					    </div>
					  </div>
					</div>
