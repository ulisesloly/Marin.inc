...
<?php	
	if($_POST[registro] == "registro"){
		//print_r($_POST);
		//$q="INSERT INTO 'clientes' (nombre, email, telefono, nacionalidad, direccion, numero, municipio, usuario, contrasena, fecha) VALUES ( '$_POST[nombre]', '$_POST[email]', '$_POST[telefono]', '$_POST[nacionalidad]', '$_POST[direccion]', '$_POST[numero]', '$_POST[municipio]', '$_POST[usuario]', '$_POST[contrasena]', CURRENT_TIMESTAMP)";
		
		//echo $q="INSERT INTO `clientes`(`id`, `nombre`, `email`, `telefono`, `nacionalidad`, `direccion`, `numero`, `municipio`, `usuario`, `contrasena`) VALUES (NULL,'$_POST[nombre]','$_POST[email]','$_POST[telefono]','$_POST[nacionalidad]','$_POST[direccion]','$_POST[numero]','$_POST[municipio]','$_POST[usuario]','$_POST[contrasena]')";
		$q="INSERT INTO `clientes`(`id`, `nombre`, `email`, `telefono`, `nacionalidad`, `direccion`, `numero`, `municipio`, `usuario`, `contrasena`) VALUES (NULL,'$_POST[nombre]','$_POST[email]','$_POST[telefono]','$_POST[nacionalidad]','$_POST[direccion]','$_POST[numero]','$_POST[municipio]','$_POST[usuario]','$_POST[contrasena]')";
		//print_r($q);
			    ...
			    <form class="well form-horizontal" method="post"  id="formulario" name="fRegistro">
					...
					<div class="form-group">
					  <label class="col-md-4 control-label">Municipio</label>  
					    ...
					    <div class="input-group">
					        <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
					  <input name="municipio" id="municipio" placeholder="Municipio" class="form-control" type="text">
					    </div>
					  </div>
					</div>
