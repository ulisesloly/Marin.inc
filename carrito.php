                                           ...
                                           <?php while ($row = $r->fetch_assoc()){?>
                                            <tr class="cart_item wow fadeIn">
                                                <td class="product-thumbnail">
                                                  <img width="145" height="145" alt="<?php echo $row[nombre]?>" class="shop_thumbnail" src="img_producto/<?php echo $row[codigo]?>.jpg">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- <form id="form1" method="post" action="confirmacion.php"> -->
																										<form id="form1" method="post" action="tarjeta-pago.php">
