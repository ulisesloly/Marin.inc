...
if($consulta != ""){
    ...
    $query =   "SELECT id,nombre,codigo, frase_promocional, precio,image FROM productos
            ";
...
$inicio=$pag * $max;
//$query=" SELECT nombre, frase_promocional, precio FROM productos ORDER BY nombre DESC";
$query_limit= $query ." LIMIT $inicio,$max";
                    ...
                    <div class="product-bit-title text-center padd-y-b-10">
                        ...
                        <form class="form-inline" action="" method="get">
                            ...
                            <select name="pre" id="" class="form-control" onChange="submit();">
                                ...
                                <option value="0;999" <?php if($_GET["pre"] == "0;999") echo "selected"; ?>>Entre $0 y $1.000</option>
                ...
                <div class="col-md-3 col-sm-6 wow fadeIn">
                    <figure class="single-shop-product">
                        ...
                        <style type="text/css">
                          ...
                          <!-- Nombre de la imgen de producto en base al codigo -->
                            <a href="producto.php?id=<?php echo $row[id]?>"> <img src="img_producto/<?php echo $row[image]?>" class="i img-responsive img-thumbnail producto-tienda" alt="<?php echo $row[nombre]?>"></a>
                        </div>
